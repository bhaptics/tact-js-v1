 ...
 * @returns {Promise<boolean>}
 */
export function registry_and_initialize(
  app_id: string,
  api_key: string,
  init_json_string: string
): Promise<boolean>;
/**
 * @param {string} host
 * @param {string} app_id
 ...
 */
export function retry_initialize(
  app_id: string,
  api_key: string
): Promise<void>;
/**
 ...
 * @returns {Promise<boolean>}
 */
export function is_bhaptics_device_connected(
  position: number
): Promise<boolean>;
/**
 * @param {string} address
 ...
 * @returns {Promise<boolean>}
 */
export function is_playing_event_by_request_id(
  request_id: number
): Promise<boolean>;
/**
 ...
 * @returns {Promise<boolean>}
 */
export function is_playing_event_by_event_id(
  event_id: string
): Promise<boolean>;
/**
 * @param {string} event_name
 ...
 * @returns {Promise<number>}
 */
export function play_dot(
  position: number,
  duration_millis: number,
  motor_values: Int32Array
): Promise<number>;
/**
 * @param {number} position
 * @param {number} duration_millis
...
export interface InitOutput {
  ...
  readonly registry_and_initialize: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly remote_registry_and_initialize: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly play_position_with_parameter: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h205994645c899932: (
    a: number,
    b: number,
    c: number
  ) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h56c240c94952370d: (
    a: number,
    b: number,
    c: number
  ) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__hdb5c37827ce37372: (
    a: number,
    b: number,
    c: number,
    d: number
